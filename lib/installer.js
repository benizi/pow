...
(function() {
  ...
  module.exports = Installer = (function() {
    ...
    Installer.getSystemInstaller = function(configuration) {
      ...
      files = [new InstallerFile("/etc/systemd/system/cx.pow.firewall.service", firewallSource(this.configuration), true)];
    ...
    Installer.getLocalInstaller = function(configuration) {
      this.configuration = configuration;
      return new Installer([new InstallerFile("" + process.env.HOME + "/.config/systemd/user/cx.pow.powd.service", daemonSource(this.configuration))]);
    };
