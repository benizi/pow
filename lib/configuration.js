...
(function() {
  var Configuration, Logger, async, compilePattern, fs, getFilenamesForHost, getUserEnv, homePath, mkdirp, path, rstat, sourceScriptEnv,
    __slice = [].slice;
  ...
  module.exports = Configuration = (function() {
    ...
    Configuration.prototype.initialize = function(env) {
      ...
      this.supportRoot = homePath("Pow");
      this.hostRoot = (_ref11 = env.POW_HOST_ROOT) != null ? _ref11 : path.join(this.supportRoot, "Hosts");
      this.logRoot = (_ref12 = env.POW_LOG_ROOT) != null ? _ref12 : homePath("Pow", "Logs");
  ...
  homePath = function() {
    ...
    return path.join.apply(path, [process.env.HOME].concat(__slice.call(args)));
  };
